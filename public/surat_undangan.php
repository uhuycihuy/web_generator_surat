...
<body class="surat-undangan">
    <header class="header surat-undangan">
    ...
    <div class="container">
        <div class="form-section">
            <div class="form-header">
                <div class="form-icon surat-undangan">✉️</div>
            ...
            <form id="suratUndanganForm" method="POST" action="../backend/controllers/SuratUndanganController.php">
                ...
                <div class="form-group">
                    ...
                    <textarea id="agenda" name="agenda" class="form-textarea" placeholder="Contoh: Konsolidasi dan Asistensi Penyusunan KAK" required></textarea>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="narahubung" name="narahubung" class="form-input" placeholder="Contoh: Altist Ibnu Hajar" required>
                </div>

                <div class="form-group">
                    <label class="form-label required">Nomor Narahubung</label>
                    <input type="tel" id="no_narahubung" name="no_narahubung" class="form-input" placeholder="Contoh: 08123456789" required>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="employee-selector">
                        ...
                        <div class="employee-list" id="employee-list">
                            <?php foreach ($daftarPegawai as $p): ?>
                                <div class="employee-item" data-nip="<?= htmlspecialchars($p['nip']) ?>">
                                    <input type="checkbox" class="employee-checkbox" id="emp_<?= htmlspecialchars($p['nip']) ?>">
                                    <label for="emp_<?= htmlspecialchars($p['nip']) ?>" class="employee-name">
                    ...
                    <div class="pegawai-luar-form" id="pegawai_luar_form">
                        ...
                        <button type="button" class="btn btn-primary surat-undangan" id="tambah_luar" style="font-size: 12px; padding: 6px 12px;">
                            ➕ Tambah
                        </button>
                    </div>
                </div>
                ...
                <div class="form-buttons">
                    ...
                    <button type="submit" name="action" value="export_word" class="btn btn-success"> Download </button>
                    <?php else: ?>
        ...
        <div class="preview-section surat-undangan">
            <div class="preview-header surat-undangan">
                <h3>Preview Surat Undangan</h3>
            </div>
            <div class="preview-content" id="previewContent">
                <div class="preview-placeholder surat-undangan">
    ...
    <script src="assets/surat_undangan.js"></script>
</body>
</html>